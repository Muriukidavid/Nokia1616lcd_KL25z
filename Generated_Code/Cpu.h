...
**     Date/Time   : 2015-05-29, 19:47, # CodeGen: 7
**     Abstract    :
**
**     Settings    :
**
...
#define CPU_BUS_CLK_HZ                  16666667U /* Initial value of the bus clock frequency in Hz */
#define CPU_CORE_CLK_HZ                 33333333U /* Initial value of the core/system clock frequency in Hz.  */

#define CPU_CLOCK_CONFIG_NUMBER         0x01U /* Specifies number of defined clock configurations. */

#define CPU_BUS_CLK_HZ_CLOCK_CONFIG0    16666667U /* Value of the bus clock frequency in the clock configuration 0 in Hz. */
#define CPU_CORE_CLK_HZ_CLOCK_CONFIG0   33333333U /* Value of the core/system clock frequency in the clock configuration 0 in Hz. */
...
#define CPU_CORE_CLK_HZ_CONFIG_0        33333333UL /* Core clock frequency in clock configuration 0 */
#define CPU_BUS_CLK_HZ_CONFIG_0         16666667UL /* Bus clock frequency in clock configuration 0 */
